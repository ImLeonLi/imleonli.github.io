...
![图1、多模态大语言模型（MM-LLMs）的通用实现框架](2025-12-01-qwen-vl-series-technical-analysis/fig1-mm-llm-framework.jpg)
...
![图2、CLIP 训练和推理阶框架图](2025-12-01-qwen-vl-series-technical-analysis/fig2-clip.jpg)
*图2、CLIP 训练和推理阶框架图*
...
![图3、标准 ViT 的处理流程](2025-12-01-qwen-vl-series-technical-analysis/fig3-vit.jpg)
*图3、标准 ViT 的处理流程*
...
![图4、ViT 源码卷积操作图示（nn.Conv2d）](2025-12-01-qwen-vl-series-technical-analysis/fig4-vit-conv.jpg)
*图4、ViT 源码卷积操作图示（nn.Conv2d）*

**代码注释 2 的处理过程**：按行优先展开，处理成一个二维格式的数据 `[sequence_len, hidden_size] = [1024, 1664]`（类似于一条文本处理后的序列）。如图 5 所示。

![图5、ViT 源码格式化序列特征过程](2025-12-01-qwen-vl-series-technical-analysis/fig5-vit-sequence.jpg)
*图5、ViT 源码格式化序列特征过程*
...
![图6、Cross-Attention 特征向量压缩示意图](2025-12-01-qwen-vl-series-technical-analysis/fig6-cross-attention.jpg)
...
![图7、多模态预训练的样本示例](2025-12-01-qwen-vl-series-technical-analysis/fig7-sample.jpg)
*图7、多模态预训练的样本示例*

样本中的 demo.jpg：

![图8、demo.jpg](2025-12-01-qwen-vl-series-technical-analysis/fig8-demo.jpg)
*图8、demo.jpg*
...
![图9、Qwen-VL 三阶段模型训练](2025-12-01-qwen-vl-series-technical-analysis/fig9-training.jpg)
*图9、Qwen-VL 三阶段模型训练*
...
![图10、Qwen2-VL 模型参数](2025-12-01-qwen-vl-series-technical-analysis/fig10-params.jpg)
*图10、Qwen2-VL 模型参数*
...
![图11、Qwen-VL VS Qwen2-VL 的图像处理](2025-12-01-qwen-vl-series-technical-analysis/fig11-dynamic-resolution.jpg)
...
![图12、Patch' Pack 示例](2025-12-01-qwen-vl-series-technical-analysis/fig12-patch-pack.jpg)
*图12、Patch' Pack 示例*
...
![图13、Patch' Pack Attention Mask](2025-12-01-qwen-vl-series-technical-analysis/fig13-attention-mask.jpg)
...
![图14、RoPE 矩阵](2025-12-01-qwen-vl-series-technical-analysis/fig14-rope-matrix.jpg)
*图14、RoPE 矩阵*
...
![图15、RoPE 计算](2025-12-01-qwen-vl-series-technical-analysis/fig15-rope-calc.jpg)
*图15、RoPE 计算*

由于上述 `R_m` 变换矩阵比较稀疏，直接用矩阵乘法来实现会浪费算力，苏神也给出了一个推荐的实现方式，如下：

![图16、RoPE 实现](2025-12-01-qwen-vl-series-technical-analysis/fig16-rope-impl.jpg)
*图16、RoPE 实现*
...
![图17、Qwen2-VL 输入投影层 vision token 压缩流程](2025-12-01-qwen-vl-series-technical-analysis/fig17-mlp-adapter.jpg)
...
![图18、M-RoPE](2025-12-01-qwen-vl-series-technical-analysis/fig18-mrope.jpg)
*图18、M-RoPE*
...
![图19、3D 卷积对帧序列做特征抽取操作](2025-12-01-qwen-vl-series-technical-analysis/fig19-3d-conv.jpg)
...
![图20、Qwen2-VL 评估效果](2025-12-01-qwen-vl-series-technical-analysis/fig20-evaluation.jpg)
*图20、Qwen2-VL 评估效果*
...
![图21、Qwen2.5-VL](2025-12-01-qwen-vl-series-technical-analysis/fig21-qwen25vl.jpg)
*图21、Qwen2.5-VL*
